...
switch(jogadores) {
    ...
    case 'Garrincha' :
        ...
        case 'Romário' :
                ...
                img.setAttribute('src', 'imagens/jogadores/Romario.jpg')
                break;

        case 'Rivaldo' :
           res.innerHTML = `<h1>Rivaldo</h1> </br> <p> Rivaldo conquistou a Copa de 2002 de pela Seleção Brasileira, foi um dos protagonistas ao lado de Ronaldo na conquista. Rivaldo ainda conquistou 1 Copa América e uma uma Copa das confederações pela Seleção Brasileira. Rivaldo fez 37 Gols pela Seleção.  </p>       `
